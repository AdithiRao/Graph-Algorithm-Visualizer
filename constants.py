...
# COLORS[VISITED] = 
# COLORS[PICKUP_VISITED] = 
COLORS[CURR_VISITING] = Color("#F3F76E")
COLORS[DONE_VISITING] = Color("#62F786")
COLORS[DONE_PICKUP_VISITING] = Color("#EEAA21")
COLORS[FOUND] = Color("#80aebe")
COLORS[SHORTEST_PATH_NODE] = Color("#F7F777")
COLORS[TO_WEIGHT] = Color("#470f00")
COLORS[WEIGHTED] = Color("#61869b")
COLORS[WALL] = Color("#007e80")

END_COLOR = {}
END_COLOR[DONE_VISITING] = Color("#629FF7") #DONE_VISITING
END_COLOR[DONE_PICKUP_VISITING] = Color("#F7627D") #DONE_PICKUP_VISITING
